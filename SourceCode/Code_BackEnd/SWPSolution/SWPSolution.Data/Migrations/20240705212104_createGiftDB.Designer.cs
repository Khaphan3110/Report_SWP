...
namespace SWPSolution.Data.Migrations
{
    ...
    [Migration("20240705212104_createGiftDB")]
    partial class createGiftDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SWPSolution.Data.Entities.Gift", b =>
                {
            ...
            modelBuilder.Entity("SWPSolution.Data.Entities.GiftPurchase", b =>
                {
                    b.Property<int>("GiftPurchaseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("giftpurchase_ID");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GiftPurchaseId"));
                    ...
                    b.HasKey("GiftPurchaseId")
                        .HasName("PK_GiftPurchase");

                    b.HasIndex("GiftId");

                    b.HasIndex("MemberId");

                    b.ToTable("GiftPurchase", (string)null);
                });
            ...
            modelBuilder.Entity("SWPSolution.Data.Entities.GiftPurchase", b =>
                {
                    b.HasOne("SWPSolution.Data.Entities.Gift", "Gift")
                        .WithMany("GiftPurchases")
